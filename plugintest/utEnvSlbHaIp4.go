...
func NewSlbHaIp4Env() *SlbHaIp4Env {
	utEnv := UtEnv{
...
func (env *SlbHaIp4Env) SetupStrap() *SlbHaIp4Env {
...
func (env *SlbHaIp4Env) DestroyBootStrap() {
	env.envLock.Lock()
	defer env.envLock.Unlock()
...
func (env *SlbHaIp4Env) SetupVyosHa() {
	/* keepalived conf
	/enableVyosha
	"keepalive":10,
	"heartbeatNic":"fa:10:7a:f3:61:01",
	"peerIp":"10.86.5.197",
	"peerIpV6":"2023:12:26:1::4c:3bb3",
	"localIp":"10.86.5.161",
	"localIpV6":"2023:12:26:1::37:44f3",
	"monitors":[],
	"vips":[{"nicMac":"fa:10:7a:f3:61:01","nicVip":"10.86.5.154","netmask":"255.255.255.0"}
	*/
	...
	//keepConf, err := os.ReadFile(plugin.GetKeepalivedConfigFile())
	//Expect(err).To(BeNil(), "keepalived file created")
	//Expect(strings.Compare(string(keepConf), slbHaIp4keepalivedConf) == 0).To(BeTrue(), "keepalived conf correct: %s", keepConf)

}

func (env *SlbHaIp4Env) SetupLb() {
	plugin.InitLb()
...
func (env *SlbHaIp4Env) DestroyLb() {

...
type SlbHaIp6Env struct {
	UtEnv
}

func NewSlbHaIp6Env() *SlbHaIp6Env {
	utEnv := UtEnv{
...
func (env *SlbHaIp6Env) SetupSlbHa6BootStrap() *SlbHaIp6Env {
...
func (env *SlbHaIp6Env) DestroySlbHa6BootStrap() {
	env.envLock.Lock()
	defer env.envLock.Unlock()
...
func (env *SlbHaIp6Env) SetupVyosHa6() {
	/*
		...
		/enableVyosha,
		"keepalive":10,
		"heartbeatNic":"fa:c1:cb:52:24:01",
		"peerIp":"10.86.5.161",
		"peerIpV6":"2023:12:26:1::2f:9897",
		"localIp":"10.86.5.157",
		"localIpV6":"2023:12:26:1::5c:6fab",
		"monitors":[],
		"vips":[{"nicMac":"fa:c1:cb:52:24:01","nicVip":"2023:12:26:1::7a:bcf","prefixLen":64}
	*/
